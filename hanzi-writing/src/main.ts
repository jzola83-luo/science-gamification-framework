...
app.innerHTML = `
  <div class="app-shell">
    <header class="site-header">
      ...
      <span class="header-pill" id="quest-status">Practice · 1 character</span>
    </header>
    <main>
      <section class="quest-intro">
        <div class="quest-intro__copy">
          <p class="eyebrow eyebrow--light">The meadow quest</p>
          <h2>Help the horse find its name.</h2>
          <p>Learn to write the character for “horse”. Each correct stroke brings you closer to completing the quest.</p>
        </div>
...
moduleHost.addEventListener('hanzi:progress', () => {
  statusPill.textContent = 'Practice · 1 character';
